...
import chat_popup from '../../assets/Chat_popup.png';
...
import ecobot from '../../assets/ecobot.png'
import Chat_popup_ecobot from '../../assets/Chat_popup_ecobot.png'
                    ...
                    <div className={styles.chatContainer} >
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <img
                                    src={ui?.chat_logo ? ui.chat_logo : Chat_popup_ecobot}
