...
function useBoolean(initialState) {
  var _a3 = React15.useState(initialState), value = _a3[0], setValue = _a3[1];
...
function useForceUpdate2() {
  var _a3 = React19.useState(0), setValue = _a3[1];
...
var useMount = function(callback) {
  var mountRef = React22.useRef(callback);
...
var useMountSync = function(callback) {
  var mountRef = React23.useRef(callback);
  mountRef.current = callback;
  React23.useLayoutEffect(function() {
    var _a3;
    (_a3 = mountRef.current) === null || _a3 === void 0 ? void 0 : _a3.call(mountRef);
  }, []);
};
...
var useDocument = function() {
  var _a3;
  return (_a3 = React28.useContext(WindowContext).window) === null || _a3 === void 0 ? void 0 : _a3.document;
};
var WindowProvider = function(props) {
  return React28.createElement(WindowContext.Provider, { value: props }, props.children);
};
...
//# sourceMappingURL=chunk-DMQF2J7X.js.map
